...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("🤖 Admin 🤖", "https://telegram.dog/rubyMathews_Bot")
    buttons.buildbutton("👥 Group 👥", "https://t.me/bot2mirror")
...
'''
        ...
        sendMarkup('Not Authorized user, Join Our Group', context.bot, update.message, reply_markup)
